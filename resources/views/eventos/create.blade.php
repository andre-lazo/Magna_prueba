...
@endforeach</center>
 <h3 class='animate__animated animate__fadeInRightBig text-center mb-2 font-weight-bold pt-5'>HORARIOS-DISPONIBLES SALON DE EVENTOS </h3>
             
 <div id="horarios" class="animate__animated animate__fadeInRightBig">
         <center>
...
{{Form::token()}}
  <div>
      ...
      <div class="animate__animated animate__fadeInTopRight text-center font-weight-bold">
          ...
          <input readonly hidden type="text" class="form-control" name="id" id="id" value="{{Auth::user()->id}}" required>
          <label>Usuario</label>
