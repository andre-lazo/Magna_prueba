...
<div class="animate__animated animate__fadeInRightBig col-xs-12 col-lg-6 pt-5">
    <table id="tabla" class="table table-bordered table-striped table-hover bg-secondary ">
